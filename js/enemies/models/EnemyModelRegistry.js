...
export const ENEMY_MODEL_REGISTRY = {
    ...
    golden_titan: { path: 'FrostTitanModel.js', exportName: 'FrostTitanModel' },
    echo_phantom: { path: 'VoidWraithModel.js', exportName: 'VoidWraithModel' },
    shadow_self: { path: 'SimpleEnemyModel.js', exportName: 'SimpleEnemyModel' },
